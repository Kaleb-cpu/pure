...
function Profile() {
const Icons = [
  { id: "1", name: "Facebook", description: "Add your Facebook page", icon: FaFacebook },
    { id: "2", name: "Youtube", description: "Add your Youtube channel", icon: FaYoutube },
    { id: "3", name: "TikTok", description: "Add your TikTok profile", icon: FaTiktok },
    { id: "4", name: "Instagram", description: "Add your Instagram profile", icon: FaInstagram },
  ...
  return (
    <>
      ...
      <div className="mt-12">
        <H2>Profile Photo</H2>
        <div className="text-teritary flex ml-10 mt-3">
      ...
      <div className="mt-12">
        <H2>Bio</H2>
        <div class="mt-3 max-w-lg ml-4 md:ml-10 bg-secondary p-3 rounded-lg shadow-md">
      ...
      <div className="mt-12">
        <H2>Social Links</H2>
        <div class="mt-3 max-w-lg ml-4 md:ml-10">
          {Icons.map((data) => {
            return <SocialLink 
            key={data.id}
            icon= {data.icon}
